    ...
    <DialogPortal>
      <DialogOverlay>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            "relative flex h-fit min-h-screen w-full justify-center py-20 sm:px-4",
            centered ? "items-center" : "items-start",
            containerClassName
          )}
          {...props}
        >
          <div className="absolute h-full w-full" onClick={onClickOutside} />
          <div
            className={cn(
              "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] relative grid h-fit w-[500px] gap-4 border p-6 shadow-lg duration-200 sm:rounded-lg",
              className
            )}
          >
            {children}
